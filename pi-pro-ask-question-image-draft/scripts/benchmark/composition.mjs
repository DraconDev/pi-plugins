...
export const FAMILIES = Object.freeze({
  single: {
    ...
    content: "the large block holds one oversized pictogram and the two small blocks each hold a different one, all from the same small set: a ring, a filled disc, a triangle, a square, a thick bar",
  },
  column: {
    blocks: 3,
  ...
  band: {
    ...
    content: "the band is the accent colour and holds one oversized pictogram; the two blocks below each hold a different kind of pictogram",
  },
  rail: {
    blocks: 2,
    draw: "one narrow tall block pinned to the left edge, with one wide block filling the rest of the frame",
    content: "the narrow block holds three stacked pictograms of different kinds and the wide block holds two more",
  },
  overlay: {
    blocks: 2,
    ...
    content: "the front panel is the accent colour and holds one oversized pictogram; the shape behind it is a large pale ring",
  },
  stack: {
    blocks: 3,
    ...
    content: "the front rectangle is the accent colour and carries one oversized pictogram, and the two behind it are plain outlines",
  },
  flow: {
    blocks: 3,
  ...
  tree: {
    ...
    content: "each block holds one oversized pictogram of a different kind and only the top block is the accent colour",
  },
  stages: {
    blocks: 3,
