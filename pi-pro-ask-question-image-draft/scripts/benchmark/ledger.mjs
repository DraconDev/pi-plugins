...
const DEFECTS = [
  ...
  },
  {
    ...
    summary: "Neither half of the visual gate is met by any image arm, and the reason is now measured rather than suspected. Generated image alone: 92/200 wins (46.0%, LB 39.2%) and 7.5% legibility-severe. Composed preview: 109/200 wins (54.5%, LB 47.6%) and 31.0% legibility-severe. Structure alone: 94/200 wins (47.0%). The text baseline is charged 0.0% legibility on the same rubric.",
    rootCause: "Two independent limits, both measured. Wins cap out near 55% because the decision content in this stratum is verbal - in 171 of the losses the judge credits the text arm for 'stating each treatment's trade-off', which no image at any resolution restates; the image arm wins the cases whose question is genuinely about arrangement. Legibility caps the other way: the raw art is clean at 7.5%, but any text the package draws at 248 x 256 pixels is read as pixelated by a vision judge (62 of 82 composed severe calls), so composing legible structure into the preview trades win rate for legibility and cannot pass both halves at once.",
    fix: "Every product lever was taken and is shipped: the prompt is written in display units (discriminability is 0 of 200, against 46 of 69 before), the drawn structure now follows each treatment's own arrangement with no two treatments of a case drawn alike, the composed preview is deterministic and reproducible, and the rubric separates legibility from discriminability and answerability so every number above is attributable. What is left is not a defect in the harness: it is that 60% wins, a lower bound above 50%, and 2% legibility cannot hold together on a 31 x 16 cell preview whose questions are answered in words.",
    claim: { ceiling: 0.02, ceilingClass: "legibility", arms: { image: { wins: 92, rate: 0.46, legibility: 0.075 }, composed: { wins: 109, rate: 0.545, legibility: 0.31 }, structure: { wins: 94, rate: 0.47 } } },
  },
  {
